...
# reliquidar_ce.sh
#
#	Reliquidación de la bandeja de corte electoral


USO="uso: reliquidar_ce.sh --inicio yyyy-mm-aa --fin yyyy-mm-aa"
...
PREBANDEJA=prebandeja_ce.sql
BANDEJA=bandeja_ce.sql
POSBANDEJA=posbandeja_ce.sql
...
CREATE TEMPORARY TABLE `ivariablestmp` (
  ...
  `CompElecPeriodoOpcionId` int(11)
)
'
...
concat(char(34),"CORTEELECTORAL",char(34)),",",
concat(char(34),VarAnio,char(34)),",",
concat(char(34),VarMes,char(34)),
"),"
...
$RESULTADO;
insert into periodos (bandeja,desde,hasta) values ('ce','$DESDE','$HASTA');
